...
import { Pencil, X, User, Phone, Globe, MapPin, FolderOpen } from 'lucide-react'
      ...
      {open && (
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: 16, fontWeight: 600, color: 'var(--text-1)', marginBottom: 20 }}>Editar Lead</h2>
